namespace Sequor.WebMvc
{
    ...
    [Table("WSQOLEXPREMESSAITENSNRSERIECOMPONENTEHIST")]
    public partial class WSQOLEXPREMESSAITENSNRSERIECOMPONENTEHIST
    {
        public long ID { get; set; }

        public long? ID_NR_SERIE_COMPONENTE { get; set; }
